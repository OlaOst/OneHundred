...
unittest
{
  ...
  assert(index.find(vec2(0.0, 0.0), 2.0) == [firstElement], index.find(vec2(0.0, 0.0), 2.0).to!string);
  ...
  assert(index.find(vec2(0.0, 0.0), 1050.0) == [firstElement, secondElement], index.find(vec2(0.0, 0.0), 1050.0).to!string);
  
  /+
  auto test1 = index.findCoveringIndices(vec2(16384.0, 16384.0), 4.0, true);
  auto test2 = index.findCoveringIndices(vec2(16384.0, 16384.0), 1.0, true);
